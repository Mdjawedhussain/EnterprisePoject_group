...
#define BLYNK_TEMPLATE_ID "TMPLmFRx6q_o"
#define BLYNK_DEVICE_NAME "smart parking system by coderhaters"
#define BLYNK_PRINT Serial
#include <ESP8266WiFi.h>
#include <BlynkSimpleEsp8266.h>

char auth[] = "Fr46mHGC5zPaMYUtA5dzHORrZXbQuGoM"; //enter auth code
char ssid[] = "robertraj"; //enter wifi name
